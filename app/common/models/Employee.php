 ...
 * @property string $nationality Гражданство
...
class Employee extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Возвращает массив возможных статусов сотрудника.
     * @return array
     */
    public static function getStatusList()
    {
        return [
            self::STATUS_INACTIVE => 'В обработке',
    ...
    {
        return [
            [['firstName', 'lastName', 'post', 'age'], 'required'],
            ['email', 'email'],
